...
require_once 'Database.php';   // ← crée $conn global
require_once 'model.php';      // ← utilise $conn global
...
file_put_contents('C:/xampp/htdocs/gestion/debug.txt', "JSON: $json\nMethod: {$_SERVER['REQUEST_METHOD']}\n");
...
try {
    ...
    if ($statut === 'en_attente') {
        ...
        echo json_encode(['success' => false, 'error' => 'Votre compte est en attente de validation.']);
        exit();
    }

    if ($statut === 'inactif') {
        http_response_code(403);
        echo json_encode(['success' => false, 'error' => 'Votre compte a été désactivé.']);
        exit();
    }
