...
def tester_rfid(rfid_code):
    ...
    # Vérifier si la carte existe dans les employés
    ...
    if user:
        ...
        # ✅ Carte en attente de validation RH
        ...
        # ✅ Carte inconnue → insérer un employé temporaire en attente
        # Vérifier si ce rfid_code est déjà en attente
        cursor.execute("""
        ...
        if deja_existant:
            ...
            # Première détection → créer un employé temporaire
            cursor.execute("""
            ...
            """, (
                f"rfid_{rfid_code}@inconnu.local",  # email temporaire unique
                rfid_code,
                today,
                now_datetime
            ))
