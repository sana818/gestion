...
/* ── Bloquer tout affichage HTML d'erreur avant les headers ── */
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    /* ✅ Accepter le rôle envoyé, uniquement employe ou responsable_rh */
    $rolesAutorises = ['employe', 'responsable_rh'];
    $role = in_array($input['role'] ?? '', $rolesAutorises)
          ? $input['role']
          : 'employe';
    ...
    try {
        ...
        /* Insérer dans registre avec le rôle correct */
        $stmt = $db->prepare("
