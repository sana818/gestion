...
// ── Validation JWT (rôle administrateur uniquement) ──
function validateDirecteur(): object {
    ...
    // ✅ CORRECTION : rôle 'administrateur' (pas 'directeur')
...
// ✅ CORRECTION : table 'employes' (pas 'registre')
