    ...
    if user:
        ...
        if presence:
            ...
            if heure_depart is None:
                # 2ème scan → sortie + statut presence = absent
                cursor.execute("""
                    UPDATE presence 
                ...
                print(f"Statut → 'absent' dans presence ⚠️")
                print(f"Statut → 'en_attente' dans registre ⚠️")
            ...
            print(f"Statut → 'présent' dans presence ✅")
