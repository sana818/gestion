...
try {
    ...
    if (!empty($user['photo_profil'])) {
        ...
        if (empty($name)) $name = 'Utilisateur';
        $user['photo_profil'] = 'https://ui-avatars.com/api/?name=' . urlencode($name) . '&size=180&background=4a6fa5&color=fff&bold=true';
    }

    // Ajouter les champs manquants que le JavaScript attend
    $user['derniere_entree'] = '08:45';
    $user['derniere_sortie'] = '18:30';
    $user['departement'] = 'Développement';
    $user['salle'] = 'Bureau 203';
    $user['heure_arrivee'] = '09:00';
    $user['heure_sortie'] = '18:00';
