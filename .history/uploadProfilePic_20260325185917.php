...
/* ── Upload ── */
try {
    // ✅ Récupérer l'ID de l'employé ciblé (pas l'admin connecté)
    $targetId = isset($_POST['employee_id']) ? intval($_POST['employee_id']) : $userId;
    ...
    // ✅ Met à jour la photo de l'employé ciblé
