...
try {
    ...
    if ($statut === 'en_attente') {
        ...
        echo json_encode([
            'success' => false,
            'error'   => 'Votre compte n\'est pas encore activé. Veuillez badger votre carte d\'accès pour activer votre compte.'
        ]);
        exit();
    }
    ...
    if ($statut === 'refuse') {
        ...
        echo json_encode([
            'success' => false,
            'error'   => 'Votre demande d\'accès a été refusée. Contactez l\'administration.'
        ]);
        exit();
    }
